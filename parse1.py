...
Token = Num | Bool | Keyword | Identifier | Operator | BitwiseOperator | List| String| Method | Power| Braces
    ...
    def next_token(self) -> Token:
        ...
        try:
            match self.stream.next_char():
                ...
                case c if c in brackets: return Braces(c)
